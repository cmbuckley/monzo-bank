;(function () {
  ...
  function apiRequest (options, fn) {
    ...
    options.json = true
    options.headers = options.headers || {}
    options.headers.client = 'NodeMonzo-v' + version
   ...
   * @method token
   * @static
   * @param {object} credentials Monzo credentials
   * @param {string} credentials.client_id Dev API client id
   * @param {string} credentials.client_secret Dev API client secret
   * @param {string} credentials.username Monzo user’s username
   * @param {string} credentials.password Monzo user’s password
   ...
   *     })
   *
   * @see https://monzo.com/docs/#acquiring-an-access-token
   */
   ...
   *
   * @see https://monzo.com/docs/#authenticating-requests
   */
   ...
   *     })
   *
   * @see https://monzo.com/docs/#refreshing-access
   */
   ...
   *
   * @see https://monzo.com/docs/#list-accounts
   */
   ...
   *
   * @see https://monzo.com/docs/#read-balance
   */
   ...
   * Get detailed information about customer’s accounts
   *
   *     potsPromise = monzo.pots(accessToken)
   *
   * @see https://docs.monzo.com/#list-pots
   */
  function pots (account_id, access_token, fn) {
    var options = {
      uri: methodPaths.pots,
      qs: {
  ...
  function receipts (access_token, fn) {
    var options = {
      uri: methodPaths.receipts
    }
    return apiRequestAuthenticated(options, access_token, fn)
  }
   ...
   *     }, access_token)
   *
   * @see https://monzo.com/docs/#list-transactions
   */
   ...
   *     }, access_token)
   *
   * @see https://monzo.com/docs/#retrieve-transaction
   */
   ...
   *     }, access_token)
   *
   * @see https://monzo.com/docs/#create-feed-item
   */
   ...
   *
   * @see https://monzo.com/docs/#registering-a-web-hook
   */
   ...
   *
   * @see https://monzo.com/docs/#list-web-hooks
   */
   ...
   *
   * @see https://monzo.com/docs/#deleting-a-web-hook
   */
   ...
   *     }, access_token)
   *
   * @see https://monzo.com/docs/#register-attachment
   */
   ...
   *     }, access_token)
   *
   * @see https://monzo.com/docs/#upload-attachment
   * @param {object} params params object
   ...
   *
   * @see https://monzo.com/docs/#deregister-attachment
   */
